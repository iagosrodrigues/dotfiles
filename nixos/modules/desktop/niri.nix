  ...
  flake = {
    modules = {
      nixos.niri =
        ...
        in
        {
          options.local.desktop.niri.enable = lib.mkEnableOption "Niri scrolling window manager";
      ...
      homeManager.niri =
        ...
        in
        {
          ...
          options.local.desktop.niri.enable = lib.mkEnableOption "Niri home-manager configuration";
